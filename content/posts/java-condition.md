...
![ArrayBlockingQueue类图](/images/java-condition-1.jpg)
...
![ConditionObject类结构](/images/ConditionObject.png)
...
AQS的方法。`getState()`方法获取的就是AQS里面的state变量，在`ReentrantLock`中，其实state保存的是重入的次数（参考《可重入锁ReentrantLock源码阅读》）。
...
![pthread_wait](/images/java-condition-3.jpg)

![pthread_signal](/images/java-condition-4.jpg)
